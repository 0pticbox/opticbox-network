-- 0PTICBOX Network v25: complete member profile migration
-- Safe to run more than once in the Supabase SQL Editor.
-- Includes the v23/v24 profile compatibility fixes plus the v25 shared
-- layout, favorite Instagram highlight photo, and YouTube embeds.
...
set
  ...
  instagram_highlight_image_url = case when btrim(coalesce(instagram_highlight_image_url,'')) = '' then 'assets/profile/0pticbox-instagram-highlight.png' else instagram_highlight_image_url end,
  instagram_highlight_post_url = case when btrim(coalesce(instagram_highlight_post_url,'')) = '' then 'https://www.instagram.com/p/CIQsKb5loyL/' else instagram_highlight_post_url end,
